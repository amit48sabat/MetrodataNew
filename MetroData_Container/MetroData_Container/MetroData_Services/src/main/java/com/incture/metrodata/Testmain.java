...
public class Testmain {
	...
	public static void main(String[] args) throws javax.mail.MessagingException, IOException {
		...
		try {
			...
			String htmlMsg = "" + "<p>Bukti penerimaan barang sbb :</p>" + "<table style='border:0px;'>"
					+ "<tr> <th>Tanggal : <th>" + "<td>" + endTime + "</td></tr>" + "<tr> <th>Penerima : <th>" + "<td>"
...
//			helper.addAttachment("MyImageName.jpg", new ByteArrayResource(value.getBytes()));
	...
	public static JavaMailSender getJavaMailSender() {
		...
		mailSender.setUsername("metrodata.pod@gmail.com");
		mailSender.setPassword("Incture@123");
